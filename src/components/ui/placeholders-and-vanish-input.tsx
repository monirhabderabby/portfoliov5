...
export function PlaceholdersAndVanishInput({
  ...
  return (
    ...
    >
      <canvas
        className={cn(
          "absolute pointer-events-none  text-base transform scale-50 top-[20%] left-2 sm:left-5 origin-top-left filter invert dark:invert-0 pr-20",
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm  z-50 border-none dark:text-white bg-transparent text-white/80 h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-5 pr-20",
