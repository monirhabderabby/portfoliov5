                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col lg:flex-row items-start lg:items-center gap-2 lg:gap-4 text-[12px] lg:text-sm text-gray-400/90 mt-1">
                        <div className="flex items-center gap-1 ">
                          <Building2 className="lg:h-4 h-3 w-3 lg:w-4 " />
                          <span>{experience.company}</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <Calendar className="lg:h-4 h-3 w-3 lg:w-4 " />
                          <span>{experience.period}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  <p className="text-gray-400/70 text-[12px] lg:text-[14px]">
