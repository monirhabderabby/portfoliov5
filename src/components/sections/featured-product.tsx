...
export default function FeaturedProduct() {
  ...
  return (
    <section
      id="featured-product"
      className="relative mt-16 overflow-hidden border-y border-primary/10 py-20 text-white md:mt-24 md:py-24"
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_72%_32%,rgba(0,75,224,0.14),transparent_34%)]" />
      ...
      <div className="container relative px-4 md:px-6">
        <div className="grid items-center gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
          ...
          >
            <div className="absolute inset-[12%] rounded-full bg-primary/20 blur-[90px]" />
